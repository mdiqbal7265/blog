                        ...
                        <div class="card-body">
                            <form action="#" method="post" enctype="multipart/form-data" id="add_post_form">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea class="summernote-simple" name="content" placeholder="Write your content" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="submit" name="submit" value="Add Post" class="btn btn-primary" id="add_post_btn">
